// ========================================
// 📋 CONFIGURACIÓN DEL SISTEMA DE AUTORIZACIÓN NOTARIAL PARA MURO O ADOSAMIENTO
// ========================================

const CONFIG = {
    // ===== CONFIGURACIÓN GENERAL =====
    APP: {
        name: 'Notaría Digital - Autorización Notarial para Muro o Adosamiento',
        version: '1.0.0',
        author: 'Sistema Notarial Digital Chile',
        description: 'Sistema profesional para generar autorizaciones notariales de construcción con firmas digitales'
    },
    ...
    AUTOSAVE: {
        ...
        key: 'autorizacion_notarial_form_data',
        max_history: 5
    },
    ...
    MESSAGES: {
        ...
        error: {
            ...
            invalid_longitud: 'Longitud de edificación inválida',
            invalid_altura: 'Altura de edificación inválida',
    ...
    // ===== CONFIGURACIÓN ESPECÍFICA DE LA AUTORIZACIÓN =====
    AUTORIZACION: {
        tipos_construccion: [
            'adosada al deslinde común',
            'con uso de medianería', 
            'adosada al deslinde común con uso de medianería'
        ],
        propositos: [
            'certificar ante la Dirección de Obras Municipales',
            'regularizar construcción existente',
            'certificar y regularizar'
        ],
        altura_maxima_default: 3.5, // metros
        longitud_maxima: 100, // metros
        altura_maxima: 10, // metros
        comunas_rm: [
            'Santiago', 'Providencia', 'Las Condes', 'Vitacura', 'Lo Barnechea',
            'Ñuñoa', 'Macul', 'Peñalolén', 'La Reina', 'San Joaquín',
            'La Granja', 'La Florida', 'Puente Alto', 'Pirque', 'San José de Maipo',
            'La Pintana', 'El Bosque', 'Pedro Aguirre Cerda', 'San Ramón',
            'San Miguel', 'Lo Espejo', 'Estación Central', 'Cerrillos',
            'Maipú', 'Pudahuel', 'Cerro Navia', 'Renca', 'Quinta Normal',
            'Independencia', 'Recoleta', 'Conchalí', 'Huechuraba', 'Quilicura',
            'Colina', 'Lampa', 'Tiltil', 'Melipilla', 'María Pinto',
            'Curacaví', 'Alhué', 'San Pedro', 'Isla de Maipo', 'El Monte',
            'Talagante', 'Peñaflor', 'Padre Hurtado', 'Buin', 'Paine',
            'Calera de Tango'
        ]
    }
};
...
const ConfigUtils = {
    ...
    validateLongitud(longitud) {
        if (!longitud || isNaN(longitud)) return false;
        
        const numLongitud = parseFloat(longitud);
        return numLongitud >= CONFIG.VALIDATION.longitud.min &&
               numLongitud <= CONFIG.VALIDATION.longitud.max;
    },

    // Validar altura de edificación
    validateAltura(altura) {
        if (!altura || isNaN(altura)) return false;
        
        const numAltura = parseFloat(altura);
        return numAltura >= CONFIG.VALIDATION.altura.min &&
               numAltura <= CONFIG.VALIDATION.altura.max;
    },
...
ConfigUtils.log('info', 'Sistema de configuración de Autorización Notarial inicializado', {
