// ========================================
// 📋 CONFIGURACIÓN DEL SISTEMA DE AUTORIZACIÓN DE VIAJE DE MENOR
// ========================================

const CONFIG = {
    // ===== CONFIGURACIÓN GENERAL =====
    APP: {
        name: 'Notaría Digital - Autorización de Viaje de Menor',
        version: '1.0.0',
        author: 'Sistema Notarial Digital Chile',
        description: 'Sistema profesional para generar autorizaciones de viaje de menores con firmas digitales'
    },
    ...
    AUTOSAVE: {
        ...
        key: 'autorizacion_viaje_menor_form_data',
        max_history: 5
    },
    ...
    MESSAGES: {
        ...
        error: {
            ...
            invalid_age: 'La edad debe ser menor a 18 años',
            duplicate_rut: 'No puede haber RUTs duplicados',
            invalid_dates: 'Las fechas del viaje son inválidas',
...
const ConfigUtils = {
    ...
    // Validar edad
    validateAge(birthDate, currentDate = new Date()) {
        ...
        return age >= CONFIG.VALIDATION.age.min && age <= CONFIG.VALIDATION.age.max;
    },
    ...
    validatePassport(passport) {
        ...
        return CONFIG.VALIDATION.passport.pattern.test(cleanPassport);
    },
...
ConfigUtils.log('info', 'Sistema de configuración inicializado', {
