// ========================================
// 📋 CONFIGURACIÓN DEL SISTEMA DE DECLARACIÓN JURADA DE RESIDENCIA
// ========================================

const CONFIG = {
    // ===== CONFIGURACIÓN GENERAL =====
    APP: {
        name: 'Notaría Digital - Declaración Jurada de Residencia',
        version: '1.0.0',
        author: 'Sistema Notarial Digital Chile',
        description: 'Sistema profesional para generar declaraciones juradas de residencia con firmas digitales'
    },
    ...
    AUTOSAVE: {
        ...
        key: 'declaracion_residencia_form_data',
        max_history: 5
    },
    ...
    // ===== CONFIGURACIÓN ESPECÍFICA DE DECLARACIÓN JURADA DE RESIDENCIA =====
    RESIDENCIA: {
        finalidades_declaracion: [
            'cordones_sanitarios',
            'tramites_bancarios',
            'servicios_basicos',
            'educacion',
    ...
    DOCUMENT: {
        title: 'DECLARACIÓN JURADA DE RESIDENCIA',
        subtitle: '',
        legal_basis: 'Artículo 210 del Código Penal - Declaraciones Juradas',
        validity_indefinite: true, // Las declaraciones de residencia no tienen vencimiento específico
        required_docs: [
            'Cédula nacional de identidad del declarante',
            'Documento que acredite el domicilio (opcional)'
        ]
    }
};
...
const ConfigUtils = {
    ...
    generateDocumentId() {
        ...
        let result = 'DJR-'; // Declaración Jurada Residencia
        for (let i = 0; i < 8; i++) {
    ...
    // Formatear finalidad de declaración
    formatFinalidadDeclaracion(finalidad) {
        const finalidades = {
            'cordones_sanitarios': 'cordones y controles sanitarios',
            'tramites_bancarios': 'trámites bancarios',
            'servicios_basicos': 'servicios básicos',
            'educacion': 'trámites educacionales',
            'salud': 'servicios de salud',
            'trabajo': 'trámites laborales',
            'otros': 'otros fines pertinentes'
        };
...
ConfigUtils.log('info', 'Sistema de configuración de Declaración Jurada de Residencia inicializado', {
