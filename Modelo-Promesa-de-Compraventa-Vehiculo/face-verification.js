...
// ========================================
// Archivo único auto-contenido - ADAPTADO para Promesa de Compraventa de Vehículo
// Versión: 2.0.0 | Compatible con vendedor/comprador
...
(function() {
    ...
    class FaceVerificationSystem {
        ...
        validateUserData(type) {
            // ADAPTADO: Buscar campos vendedor/comprador en lugar de mandante/mandatario
        ...
        showNotification(message, type = 'info') {
            // ADAPTADO: Usar el sistema correcto (promesaSystem en lugar de poderSystem)
    ...
    function integrateClearForm() {
        ...
        // ADAPTADO: También buscar en el sistema principal (promesaSystem)
    ...
    function initializeFaceVerification() {
        ...
        console.log('🚗 Integración con sistema de Promesa de Compraventa completada');
    }
...
✅ Versión: 2.0.0 - ADAPTADO PARA VEHÍCULOS
✅ Integración: Promesa de Compraventa de Vehículo
✅ Compatibilidad: Sistema notarial adaptado
...
🔧 Adaptaciones aplicadas:
   • Campos actualizados: vendedor/comprador
   • Validación de nombres corregida
   • Integración con promesaSystem
